...
WebUI.setText(findTestObject('Object Repository/login/input_Email_username'), 'cloningan.qa@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/login/input_Password'), 'Kh8YlhhrrZq9lDrwnpLheQ==')
